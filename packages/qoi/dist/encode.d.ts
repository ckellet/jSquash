 ...
 */
export declare function init(moduleOptionOverrides?: Partial<EmscriptenWasm.ModuleOpts>): Promise<QOIModule>;
export declare function init(module?: WebAssembly.Module, moduleOptionOverrides?: Partial<EmscriptenWasm.ModuleOpts>): Promise<QOIModule>;
/**
