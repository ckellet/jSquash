...
declare function initMT(moduleOrPath?: InitInput): Promise<{
    ...
    disposeWasm: typeof import("./codec/pkg-parallel/squoosh_oxipng.js").dispose;
}>;
declare function initST(moduleOrPath?: InitInput): Promise<{
    ...
    disposeWasm: typeof import("./codec/pkg/squoosh_oxipng.js").dispose;
}>;
type WasmExports = ReturnType<typeof initMT | typeof initST>;
export declare function init(moduleOrPath?: InitInput): Promise<WasmExports>;
/**
